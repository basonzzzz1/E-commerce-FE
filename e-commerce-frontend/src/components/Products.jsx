...
const Products = () => {
    ...
    const ShowProducts = () => {
        return (
            <>
                    <div className="buttons text-center py-5 swiper" style={{width: "1111px" ,height : "200px", display : "flex"}}>
                        <Swiper
                            slidesPerView={3}
                            spaceBetween={30}
                            pagination={{
                        ...
                        >
                            <SwiperSlide>
                                <button className="btn btn-outline-dark btn-sm m-2 mi-5" onClick={() => setFilter(data)}>All</button>
                            </SwiperSlide>
                            <SwiperSlide>
